...
| [UpdateOrganizationByUid\(UpdateOrganizationByUidRequest, ServerCallContext\)](UpdateOrganizationByUid(UpdateOrganizationByUidRequest,ServerCallContext).md 'Innago\.Security\.IdpServiceFacade\.Services\.OrganizationService\.UpdateOrganizationByUid\(IdpServiceFacade\.UpdateOrganizationByUidRequest, Grpc\.Core\.ServerCallContext\)') | Updates an organization based on the provided organization\_uid\. This method implements the gRPC OrganizationBase class's definition for the UpdateOrganizationByUid operation\. |
