...
| [AddUserToOrganizationByUid\(User, string, CancellationToken\)](AddUserToOrganizationByUid(User,string,CancellationToken).md 'Abstractions\.IOrganizationService\.AddUserToOrganizationByUid\(User, string, System\.Threading\.CancellationToken\)') | Removes a user from an organization\. |
...
| [RemoveUserFromOrganizationByUid\(User, string, CancellationToken\)](RemoveUserFromOrganizationByUid(User,string,CancellationToken).md 'Abstractions\.IOrganizationService\.RemoveUserFromOrganizationByUid\(User, string, System\.Threading\.CancellationToken\)') | |
